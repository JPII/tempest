...
class Point3D
{
	...
	public static int getOriginX()  {  return midWidth;   }
	public static int getOriginY()  {  return midHeight;  }
	...
	public void turnPerspectiveOn()    {  perspectiveOn = true;   }
	public void turnPerspectiveOff()   {  perspectiveOn = false;  }
	public int getUserX()              {  return userX;           }
	public int getUserY()              {  return userY;           }
	public int getUserZ()              {  return userZ;           }
	public double getResultantX()      {  return resultantX;      }
	public double getResultantY()      {  return resultantY;      }
	public double getResultantZ()      {  return resultantZ;      }
	public static int getFocalLength() {  return focalLength;     }
	...
	{
		calculateTrueY();
		return -trueY;  // The negative sign compensates for the fact that the Y value on a graphics screen increase as they go down instead of up.
	}
	...
	{
   		if (perspectiveOn)
   			trueX = (int)(((resultantX + translateX) * focalLength) / (zDistance - resultantZ - translateZ));
   		else
	...
	{
   		if (perspectiveOn)
   			trueY = (int)(((resultantY + translateY) * focalLength) / (zDistance - resultantZ - translateZ));
   		else
	...
	{
		return this.userX == that.userX && this.userY == that.userY && this.userZ == that.userZ;
	}
	...
	public void translateZ(double t)  {  translateZ = t;  }
